...
class LSLRGradientDescentLearningRule(nn.Module):
    ...
    def update_params(self, names_weights_dict, names_grads_wrt_params_dict, generated_alpha_params, generated_beta_params,learning_rate_penalty, num_step, tau=0.1):
        """Applies a single gradient descent update to all parameters.
        All parameter updates are performed using in-place operations and so
        nothing is returned.
        Args:
        ...
        for key in names_grads_wrt_params_dict.keys():
            ...
            if self.alfa and generated_alpha_params != {}:
                if self.random_init:
                ...
                if learning_rate_penalty != {}:
                    updated_names_weights_dict[key] = names_weights_dict[key] - self.init_lr_val * learning_rate_penalty[key] * names_grads_wrt_params_dict[key]
                else:
